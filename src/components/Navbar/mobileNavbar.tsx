...
const MobileNavbar = () => {
  ...
  return (
    <>
      <div className="fixed right-4 sm:right-12 mt-4 sm:mt-6 z-[60] flex items-center space-x-4 lg:hidden">
        <button
      ...
      <div
        className={`fixed top-12 flex w-full justify-center transition-transform duration-200 ${
          isOpen
