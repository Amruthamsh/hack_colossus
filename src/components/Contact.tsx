    ...
    style={{
      ...
      <div className="w-full max-w-4xl text-white">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg">
            <a href="mailto:colossus@drait.edu.in" className="text-pink-400 hover:underline">colossus@drait.edu.in</a>
          </p>
          <p className="text-lg">
            <a href="mailto:hackcolossus@gmail.com" className="text-pink-400 hover:underline">hackcolossus@gmail.com</a>
          </p>
        </div>
        ...
        <div className=''>
          ...
          <div className="inline-flex space-x-4 text-2xl border-2 border-white p-3">
            <a href="#" className="text-pink-400 hover:text-pink-600"><FaInstagram /></a>
            <a href="#" className="text-pink-400 hover:text-pink-600"><FaTumblr /></a>
            <a href="#" className="text-pink-400 hover:text-pink-600"><FaPinterest /></a>
            <a href="#" className="text-pink-400 hover:text-pink-600"><FaFacebook /></a>
          </div>
        </div>
      </div>
    </div>
